...
\logo{
  ...
  % hosting venue logo (bottom left)
  \begin{tikzpicture}[remember picture, overlay]
    \node[xshift=10mm,yshift=3mm] at (current page.south west) {
        \includegraphics[height=5mm]{../00tex/logo_en.png}
    };
  \end{tikzpicture}
}
...
\begin{picture}(0,0)
\put(-220,-40){\includegraphics[height=40mm]{../00tex/sdcr.jpg}}
\put(-236.5,124){\includegraphics[width=450pt]{../00tex/banner.png}}
\end{picture}
}
